 ...
 * @author pieraggi
 */
public class SSHTunnel extends java.lang.Object{
     ...
     */
    public SSHTunnel(java.lang.String username, java.lang.String password, java.lang.String firstHost, java.lang.String secondHost, int firstHostPort, int secondHostPort) {
    ...
    public boolean connect() {
       ...
       //     System.out.println("SSH connexion successful : localhost -> "+this.getFirstHost()+":"+this.getFirstHostPort()+" -> "+this.getSecondHost()+":"+this.getSecondHostPort());
            return true;
    ...
    public java.lang.String getSecondHost() {
        return secondHost;
    }
